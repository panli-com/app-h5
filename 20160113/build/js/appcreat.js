...
var PLElements = {
    ...
    "yixun.com":".goods_buy",
    "taobao.com":".item-action,.J_bottomBar,.install-app,.thw-smartbanner,.openapp",
    "jd.com":".tryme,.cart-concern-btm-fixed,.topheader,.showfixedtop",
    "suning.com":".detail-download,.shopping-car,.app-down,.sn-client-box,.detail-download,.detail-new-download",
